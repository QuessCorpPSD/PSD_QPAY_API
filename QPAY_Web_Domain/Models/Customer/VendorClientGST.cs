...
{
    public class VendorClientGST
    {
    }
    public class VendorClientGSTGrid
    {
        public string? TotalCount { get; set; }
        public int? VendorClientGstId { get; set; }
    ...
    public class VendorClientGSTSearch
    {
        public int? VendorClientGstId { get; set; }
        public string? Company_Code { get; set; } = "";
        public string? Group_Name { get; set; } = "";
    ...
    public class VendorClientGSTRequest
    {
        public string? Action { get; set; }
        public string? UserId { get; set; }
        public string? XmlData { get; set; }
        public string? VendorClientGstId { get; set; }
    ...
    public class VendorClientGSTResponse
    {
