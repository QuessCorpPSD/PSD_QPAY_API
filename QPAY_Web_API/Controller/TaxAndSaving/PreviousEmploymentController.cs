...
namespace QPay.API.Controller.TaxAndSaving
{
    ...
    {
        private readonly IPreviousEmploymentRepository _IRepository;
        private readonly IConfiguration _configuration;
        public PreviousEmploymentController(IConfiguration configuration, IPreviousEmploymentRepository Repository)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] PrevEmploymentRequest request)
        {
