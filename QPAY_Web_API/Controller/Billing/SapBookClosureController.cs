...
namespace QPay.API.Controller.Billing
{
    ...
    [ApiController]
    public class SapBookClosureController : ControllerBase
    {
        private readonly ISapBookClosureRepository _IRepository;
        public SapBookClosureController(ISapBookClosureRepository IRepository)
        {
        ...
        [HttpGet]
        [Route("GetBusinessUnitNames")]
        public async Task<IActionResult> GetBusinessUnitNames()
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] SapBookClosureRequest request)
        {
