...
namespace QPay.API.Controller.GlobalMaster
{
    ...
    {
        private readonly IMaterialCodeRepository _IRepository;
        public MaterialCodeController(IMaterialCodeRepository IRepository)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] MaterialCodeMasterRequest request)
        {
