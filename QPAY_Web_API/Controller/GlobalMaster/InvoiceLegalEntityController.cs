...
namespace QPay.API.Controller.GlobalMaster
{
    ...
    [ApiController]
    public class InvoiceLegalEntityController : ControllerBase
    {
        private readonly IInvoiceLegalEntityRepository _IRepository;
        public InvoiceLegalEntityController(IInvoiceLegalEntityRepository IRepository)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] QuessLegalEntityRequest request)
        {
