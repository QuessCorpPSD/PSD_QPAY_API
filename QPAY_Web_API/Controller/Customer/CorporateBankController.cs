...
namespace QPay.API.Controller.Customer
{
    ...
    [ApiController]
    public class CorporateBankController : ControllerBase
    {
        private readonly ICorporateBankRepository _IRepository;
        private readonly IConfiguration _configuration;
        public CorporateBankController(IConfiguration configuration, ICorporateBankRepository Repository)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<IActionResult> Create([FromBody] CorporateBankRequest request)
        {
